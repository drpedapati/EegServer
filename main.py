...
def main():
    ...
    new_file_watch_configs = [
        {"path": os.path.join(BASE_DIR, "resting_eyesopen", "unprocessed", "raw_EGI128"), 
         "extension": "raw", 
         "queue_name": "sidecar-tasks", 
         "task_function_name": "process_new_file"},
        {"path": os.path.join(BASE_DIR, "resting_eyesopen", "unprocessed", "set_EGI128"), 
         "extension": "set", 
         "queue_name": "sidecar-tasks", 
         "task_function_name": "process_new_file"},
        {"path": os.path.join(BASE_DIR, "resting_eyesopen", "processed", "set_EGI128"), 
         "extension": "set", 
         "queue_name": "sidecar-tasks", 
         "task_function_name": "process_new_file"},
    ...
    sidecar_watch_configs = [
        {"path": SIDECAR_DIR, 
         "extension": "json", 
         "queue_name": "process-sidecar", 
         "task_function_name": "process_sidecar"},
    ]

    # Combine all watch configurations
    all_watch_configs = new_file_watch_configs + sidecar_watch_configs
    ...
    worker_process = multiprocessing.Process(
        ...
        args=(['sidecar-tasks', 'process-sidecar'], REDIS_HOST, REDIS_PORT, REDIS_DB),
        daemon=True
    )
    worker_process.start()
    print("RQ worker started and listening to 'sidecar-tasks' and 'process-sidecar' queues.")
